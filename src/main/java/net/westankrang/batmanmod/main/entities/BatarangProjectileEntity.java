package net.westankrang.batmanmod.main.entities;
...
public class BatarangProjectileEntity extends PersistentProjectileEntity {
    private static final TrackedData<Byte> LOYALTY = DataTracker.registerData(BatarangProjectileEntity.class, TrackedDataHandlerRegistry.BYTE);
    private static final TrackedData<Boolean> ENCHANTED = DataTracker.registerData(BatarangProjectileEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    private ItemStack tridentStack = new ItemStack(BatmanItems.BATARANG);
    private boolean dealtDamage;
    public int returnTimer;

    public BatarangProjectileEntity(EntityType<? extends BatarangProjectileEntity> entityType, World world) {
    ...
    public void readCustomDataFromNbt(NbtCompound nbt) {
        ...
        if (nbt.contains("Batarang", NbtElement.COMPOUND_TYPE)) {
            this.tridentStack = ItemStack.fromNbt(nbt.getCompound("Batarang"));
        }
    ...
    public void writeCustomDataToNbt(NbtCompound nbt) {
        ...
        nbt.put("Batarang", this.tridentStack.writeNbt(new NbtCompound()));
