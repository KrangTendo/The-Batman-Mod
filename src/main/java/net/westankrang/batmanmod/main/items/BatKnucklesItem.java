...
public class BatKnucklesItem extends Item {
    private final Multimap<EntityAttribute, EntityAttributeModifier> attributeModifiers;

    public BatKnucklesItem(Settings settings) {
        super(settings);
        ...
        builder.put(
                ...
                new EntityAttributeModifier(ATTACK_SPEED_MODIFIER_ID, "Tool modifier", -3.0F, EntityAttributeModifier.Operation.ADDITION)
        );
